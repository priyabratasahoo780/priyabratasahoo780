...
|  **NEXORA**   | Feature-rich E-Commerce engine with advanced product mapping, wishlist synchronization, and multi-theme architecture |  `React` `Node.js` `MongoDB`  | [![](https://img.shields.io/badge/View-A855F7?style=flat-square&logo=github&logoColor=white)](https://github.com/priyabratasahoo780) |
| **Portfolio** | A masterclass in modern UI/UX, combining GSAP-inspired transitions with a responsive glassmorphism framework   |     `React` `CSS` `Vite`      | [![](https://img.shields.io/badge/View-A855F7?style=flat-square&logo=github&logoColor=white)](https://github.com/priyabratasahoo780) |
| **REST API**  | Scalable backend architected for performance, featuring optimized Mongoose schemas and secure endpoint handling  | `Node.js` `Express` `MongoDB` | [![](https://img.shields.io/badge/View-A855F7?style=flat-square&logo=github&logoColor=white)](https://github.com/priyabratasahoo780) |
